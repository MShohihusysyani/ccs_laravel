                                ...
                                <tbody>
                                    @foreach ($added as $add)
                                        <tr>
                                            ...
                                            <td>{{ $add->tags }}</td>
                                            <td>
                                                {{-- menampilkan lebih dari 1 handle by dipisahkan dengan , --}}
                                                @php
                                                    // Gabungkan semua handle_by menjadi satu string, pisahkan dengan koma
                                                    $allHandle = implode(',', [$add->handle_by, $add->handle_by2, $add->handle_by3]);

                                                    // Pecah berdasarkan koma
                                                    $handle = explode(',', $allHandle);
                                                @endphp
