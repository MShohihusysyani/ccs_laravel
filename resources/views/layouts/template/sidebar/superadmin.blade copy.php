            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i>
                        <label class="badge badge-light-primary">13</label><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li><a href="">POS</a></li>
                            <li><label class="badge badge-light-success">New</label><a href="">CRM</a></li>
                            <li><label class="badge badge-light-success">New</label><a href="">Analytics</a></li>
                            <li><label class="badge badge-light-success">New</label><a href="">HR</a></li>
                            <li><label class="badge badge-light-success">New</label><a href="">Projects</a></li>
                            <li><label class="badge badge-light-success">New</label><a href="">Logistics</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                        ...
                        <ul class="sidebar-submenu">
                            <li><label class="badge badge-light-success">New</label><a href="">Project Details</a></li>
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                        ...
                        <ul class="sidebar-submenu">
                            <li>
                                <a class="submenu-title" href="javascript:void(0)">Products<span class="sub-arrow"><i class="fa-solid fa-angle-right"></i></span></a>
                                <ul class="sidebar-submenu">
                            ...
                            <li>
                                <label class="badge badge-light-success">New</label><a class="submenu-title" href="javascript:void(0)">Seller<span class="sub-arrow"><i class="fa-solid fa-angle-right"></i></span></a>
                                <ul class="sidebar-submenu">
                            ...
                            <li>
                                <a class="submenu-title" href="javascript:void(0)">Orders<span class="sub-arrow"><i class="fa-solid fa-angle-right"></i></span></a>
                                <ul class="sidebar-submenu">
                                    <li><a href="">Order History</a></li>
                                    <li><label class="badge badge-light-success">New</label><a href="">Order Details</a></li>
                                </ul>
                            </li>
                            <li>
                                <a class="submenu-title" href="javascript:void(0)">Invoices<span class="sub-arrow"><i class="fa-solid fa-angle-right"></i></span></a>
                                <ul class="sidebar-submenu">
                            ...
                            <li>
                                <label class="badge badge-light-success">New</label><a href="">Manage Review</a>
                            </li>
                            <li>
                                <label class="badge badge-light-success">New</label><a href="">Settings</a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title link-nav" href="">
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li><label class="badge badge-light-success">New</label><a href="">User List</a></li>
                            <li><a href="">User Cards</a></li>
                            <li><label class="badge badge-light-success">New</label><a href="">Roles & Permission</a></li>
                        </ul>
                    </li>
                    <li class="sidebar-list"><label class="badge badge-light-success">New</label><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                        <svg class="stroke-icon">
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                        ...
                        <ul class="sidebar-submenu">
                            <li>
                                <a class="submenu-title" href="javascript:void(0)">Form Controls<span class="sub-arrow"><i class="fa-solid fa-angle-right"></i></span></a>
                                <ul class="sidebar-submenu">
                            ...
                            <li>
                                <a class="submenu-title" href="javascript:void(0)">Form Widgets<span class="sub-arrow"><i class="fa-solid fa-angle-right"></i></span></a>
                                <ul class="sidebar-submenu">
                            ...
                            <li>
                                <a class="submenu-title" href="javascript:void(0)">Form layout<span class="sub-arrow"><i class="fa-solid fa-angle-right"></i></span></a>
                                <ul class="sidebar-submenu">
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                        ...
                        <ul class="sidebar-submenu">
                            <li>
                                <a class="submenu-title" href="javascript:void(0)">Bootstrap Tables<span class="sub-arrow"><i class="fa-solid fa-angle-right"></i></span></a>
                                <ul class="sidebar-submenu">
                            ...
                            <li>
                                <a class="submenu-title" href="javascript:void(0)">Data Tables<span class="sub-arrow"><i class="fa-solid fa-angle-right"></i></span></a>
                                <ul class="sidebar-submenu">
                                    <li><a href="">Basic Init</a></li>
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li><label class="badge badge-light-success">New</label><a href="">Divider</a></li>
                            ...
                            <li><label class="badge badge-light-success">New</label><a href="">Placeholders</a></li>
                            <li><a href="">Tooltip</a></li>
                            <li><a href="">Dropdown</a></li>
                            <li><a href="">Accordion</a></li>
                            <li><a href="">Tabs</a></li>
                            <li><label class="badge badge-light-success">New</label><a href="">Offcanvas</a></li>
                            <li><label class="badge badge-light-success">New</label><a href="">Navigate Links</a></li>
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li><label class="badge badge-light-success">New</label><a href="">Tree view</a></li>
                            <li><a href="">Toasts</a></li>
                            <li><label class="badge badge-light-success">New</label><a href="">BlockUI</a></li>
                            ...
                            <li><label class="badge badge-light-success">New</label><a href="">ScrollSpy</a></li>
                            <li><a href="">Breadcrumb</a></li>
                            <li><a href="">Range Slider</a></li>
                            <li><label class="badge badge-light-success">New</label><a href="">Ratios</a></li>
                            <li><a href="">Image cropper</a></li>
                            <li><a href="">Basic Card</a></li>
                            <li><a href="">Creative Card</a></li>
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li><label class="badge badge-light-success">New</label><a href="">Flash Icons</a></li>
                        </ul>
                    </li>
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                        <svg class="stroke-icon">
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li><a href="" target="_blank">Register with imagetwo</a></li>
                            <li><a href="" target="_blank">Register wizard</a></li>
                            <li><a href="" target="_blank">Account Restricted</a></li>
                    ...
                    <li class="sidebar-list"><label class="badge badge-light-success">New</label><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title link-nav" href="">
                        <svg class="stroke-icon">
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li><label class="badge badge-light-success">New</label><a href="">Gallery Placeholder</a></li>
                        </ul>
                    </li>
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                        <svg class="stroke-icon">
