                    ...
                    <ul class="nav-menus">
                        ...
                        <li class="profile-nav onhover-dropdown pe-0 py-0">
                            <div class="d-flex profile-media"><img class="b-r-10"
                                ...
                                <div class="flex-grow-1"><span>{{ ucfirst(auth()?->user()?->nama_user) }}</span>
                                    <p class="mb-0">{{ auth()?->user()->role }} <i class="middle fa-solid fa-angle-down"></i></p>
                                </div>
                            </div>
                            <ul class="profile-dropdown onhover-show-div">
                                <li><a href="',auth()->user()->role->name) }}"><i data-feather="user"></i><span>My Profile </span></a></li>
                                ...
                                <li><a href="{{ route('logout') }}" class="tombol-logout"><i data-feather="log-in"> </i><span>Log out</span></a></li>
